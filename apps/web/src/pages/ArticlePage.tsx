  ...
  return (
    <main id="main-content">
      <article className="article-page">
        ...
        <figure className="article-page__image"><img src={article.image} srcSet={stockImageSrcSet(article.image)} sizes="(max-width: 88rem) 100vw, 88rem" alt={article.alt} width={article.width} height={article.height} /><figcaption>Temporary licensed stock image. Not an HTX Super League event.</figcaption></figure>
