# Partner Brand Asset Register

**Status:** Approved for prototype use  
**Owner:** Brand lead  
**Last updated:** 2026-07-15

HTX Super League stores partner marks locally to keep presentation stable, remove runtime dependencies on other websites, and permit intentional loading and sizing. The canonical implementation notes and exact source paths live in [`apps/web/public/partners/README.md`](../../apps/web/public/partners/README.md).

## Approved portfolio and launch partners
