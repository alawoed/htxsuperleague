...
- Use Primary Navy-filled controls on light surfaces and Chalk-filled controls on Primary Navy surfaces.
- Never use Volt as the fill for a button, status label, or announcement bar.
- Use Volt on Primary Navy only for short accent labels, focus-adjacent decoration, or non-body display moments.
- Use Chalk or White for text on Primary Navy.
